...
//            return Arrays.equals(Files.readAllBytes(f), Files.readAllBytes(s));
    ...
    public static long bytesArrToLong(byte[] arr) {
        if (arr.length != 8) {
            throw new IllegalArgumentException("bytesArrToLong: Param arr " +
                    "must be the length 8");
        }
    ...
    public static byte[] additionByteArraysLength8(byte[] arr1, byte[] arr2) {
        if (!(arr1.length == 8 && arr2.length == 8)) {
            throw new IllegalArgumentException("additionByteArraysLength8: Params arr1 and arr2 " +
                    "must be the length 8");
        }
    ...
    public static byte[] subtractionByteArraysLength8(byte[] arr1, byte[] arr2) {
        if (!(arr1.length == 8 && arr2.length == 8)) {
            throw new IllegalArgumentException("subtractionByteArraysLength8: Params arr1 and arr2 " +
                    "must be the length 8");
        }
    ...
    public static byte[] additionByteArrayLength8AndLong(byte[] arr, long number2) {
        ...
        if (arrLength != 8) {
            throw new IllegalArgumentException("additionByteArrayLength8AndLong: Param arr " +
                    "must be the length 8");
        }
    ...
    public static int bytesArrToInt(byte[] arr) {
        if (arr.length != 4) {
            throw new IllegalArgumentException("bytesArrToInt: Param arr " +
                    "must be the length 4");
        }
    ...
    public static byte[] additionByteArraysLength4(byte[] arr1, byte[] arr2) {
        if (!(arr1.length == 4 && arr2.length == 4)) {
            throw new IllegalArgumentException("additionByteArraysLength4: Params arr1 and arr2 " +
                    "must be the length 4");
        }
    ...
    public static byte[] subtractionByteArraysLength4(byte[] arr1, byte[] arr2) {
        if (!(arr1.length == 4 && arr2.length == 4)) {
            throw new IllegalArgumentException("subtractionByteArraysLength4: Params arr1 and arr2 " +
                    "must be the length 4");
        }
    ...
    public static byte[] additionByteArrayLength4AndInt(byte[] arr, int number2) {
        int arrLength = arr.length;
        if (arrLength != 4) {
            throw new IllegalArgumentException("additionByteArrayLength8AndInt: Param arr " +
                    "must be the length 4");
        }
    ...
    public static byte[] multiplyingByteArrayLength4(byte[] arr1, byte[] arr2) {
        if (!(arr1.length == 4 && arr2.length == 4)) {
            throw new IllegalArgumentException("multiplyingByteArrayLength4: Params arr1 and arr2 " +
                    "must be the length 4");
        }
        int arrLength = arr1.length;
    ...
    public static byte[] multiplyingByteArrayLength4AndInt(byte[] arr, int number2) {
        int arrLength = arr.length;
        if (arrLength != 4) {
            throw new IllegalArgumentException("multiplyingByteArrayLength4AndInt: Param arr " +
                    "must be the length 4");
        }
    ...
    public static byte[] and(byte[] arr1, byte[] arr2) {
        if (arr1.length != arr2.length) {
            throw new IllegalArgumentException("and: Params arr1 and arr2 " +
    ...
    public static byte[] or(byte[] arr1, byte[] arr2) {
        if (arr1.length != arr2.length) {
            throw new IllegalArgumentException("or: Params arr1 and arr2 " +
                    "must be the same length");
        }
